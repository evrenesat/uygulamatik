...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderTableTranslation'
        db.create_table(u'at_shop_order_ordertabletranslation', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['at_shop_order.OrderTable'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('explanation', self.gf('ckeditor.fields.RichTextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'at_shop_order', ['OrderTableTranslation'])

        # Adding unique constraint on 'OrderTableTranslation', fields ['lang', 'source']
        db.create_unique(u'at_shop_order_ordertabletranslation', ['lang_id', 'source_id'])


        # Changing field 'OrderTable.explanation'
        db.alter_column(u'at_shop_order_ordertable', 'explanation', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'OrderTable.name'
        db.alter_column(u'at_shop_order_ordertable', 'name', self.gf('django.db.models.fields.TextField')(max_length=50))

    def backwards(self, orm):
        # Removing unique constraint on 'OrderTableTranslation', fields ['lang', 'source']
        db.delete_unique(u'at_shop_order_ordertabletranslation', ['lang_id', 'source_id'])

        # Deleting model 'OrderTableTranslation'
        db.delete_table(u'at_shop_order_ordertabletranslation')


        # Changing field 'OrderTable.explanation'
        db.alter_column(u'at_shop_order_ordertable', 'explanation', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'OrderTable.name'
        db.alter_column(u'at_shop_order_ordertable', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
