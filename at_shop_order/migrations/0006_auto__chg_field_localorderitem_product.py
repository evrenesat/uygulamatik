...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocalOrderItem.product'
        db.alter_column(u'at_shop_order_localorderitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.MenuItem']))

    def backwards(self, orm):

        # Changing field 'LocalOrderItem.product'
        db.alter_column(u'at_shop_order_localorderitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Product']))
