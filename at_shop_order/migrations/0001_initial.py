...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderTable'
        db.create_table(u'at_shop_order_ordertable', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('explanation', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'at_shop_order', ['OrderTable'])

        # Adding model 'OrderHead'
        db.create_table(u'at_shop_order_orderhead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('order_table', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['at_shop_order.OrderTable'])),
        ))
        db.send_create_signal(u'at_shop_order', ['OrderHead'])

        # Adding model 'LocalOrderItem'
        db.create_table(u'at_shop_order_localorderitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Application'])),
            ('order_head', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['at_shop_order.OrderHead'])),
        ...
        db.send_create_signal(u'at_shop_order', ['LocalOrderItem'])


    def backwards(self, orm):
        # Deleting model 'OrderTable'
        db.delete_table(u'at_shop_order_ordertable')

        # Deleting model 'OrderHead'
        db.delete_table(u'at_shop_order_orderhead')

        # Deleting model 'LocalOrderItem'
        db.delete_table(u'at_shop_order_localorderitem')
    ...
    models = {
        ...
        u'at_shop_order.ordertable': {
            ...
            'explanation': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
