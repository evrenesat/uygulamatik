...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalOrderItem.done'
        db.add_column(u'at_shop_order_localorderitem', 'done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocalOrderItem.done'
        db.delete_column(u'at_shop_order_localorderitem', 'done')
