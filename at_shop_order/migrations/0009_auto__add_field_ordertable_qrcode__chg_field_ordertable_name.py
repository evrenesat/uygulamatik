...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderTable.qrcode'
        db.add_column(u'at_shop_order_ordertable', 'qrcode',
    ...
    def backwards(self, orm):
        # Deleting field 'OrderTable.qrcode'
        db.delete_column(u'at_shop_order_ordertable', 'qrcode_id')
