...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LocalOrderItem.place'
        db.delete_column(u'at_shop_order_localorderitem', 'place_id')


        # Changing field 'LocalOrderItem.price'
        db.alter_column(u'at_shop_order_localorderitem', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

    def backwards(self, orm):
        # Adding field 'LocalOrderItem.place'
        db.add_column(u'at_shop_order_localorderitem', 'place',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['umatik.Place']),
                      keep_default=False)


        # Changing field 'LocalOrderItem.price'
        db.alter_column(u'at_shop_order_localorderitem', 'price', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=7, decimal_places=2))
