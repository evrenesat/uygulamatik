...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Theme.transparent_background2'
        db.add_column(u'umatik_theme', 'transparent_background2',
                      self.gf('django.db.models.fields.CharField')(default='rgba(0,0,0, 0.30)', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Theme.transparent_background2'
        db.delete_column(u'umatik_theme', 'transparent_background2')
