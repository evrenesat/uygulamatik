...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ModuleSelection', fields ['module', 'app']
        db.delete_unique(u'umatik_moduleselection', ['module_id', 'app_id'])

        # Adding unique constraint on 'ModuleSelection', fields ['module', 'app', 'xtra']
        db.create_unique(u'umatik_moduleselection', ['module_id', 'app_id', 'xtra'])


    def backwards(self, orm):
        # Removing unique constraint on 'ModuleSelection', fields ['module', 'app', 'xtra']
        db.delete_unique(u'umatik_moduleselection', ['module_id', 'app_id', 'xtra'])

        # Adding unique constraint on 'ModuleSelection', fields ['module', 'app']
        db.create_unique(u'umatik_moduleselection', ['module_id', 'app_id'])
    ...
    models = {
        ...
        u'umatik.moduleselection': {
            'Meta': {'ordering': "['order']", 'unique_together': "(('module', 'app', 'xtra'),)", 'object_name': 'ModuleSelection'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'app': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['umatik.Application']"}),
