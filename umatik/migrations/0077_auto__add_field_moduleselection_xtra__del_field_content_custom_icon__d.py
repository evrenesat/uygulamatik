...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModuleSelection.xtra'
        db.add_column(u'umatik_moduleselection', 'xtra',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'Content.custom_icon'
        db.delete_column(u'umatik_content', 'custom_icon')

        # Deleting field 'Content.icon'
        db.delete_column(u'umatik_content', 'icon_id')

        # Adding field 'Content.module_selection'
        db.add_column(u'umatik_content', 'module_selection',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.ModuleSelection'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModuleSelection.xtra'
        db.delete_column(u'umatik_moduleselection', 'xtra')

        # Adding field 'Content.custom_icon'
        db.add_column(u'umatik_content', 'custom_icon',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Content.icon'
        db.add_column(u'umatik_content', 'icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Icon'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Content.module_selection'
        db.delete_column(u'umatik_content', 'module_selection_id')
    ...
    models = {
        ...
        u'umatik.content': {
            ...
            'module_selection': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['umatik.ModuleSelection']", 'null': 'True', 'blank': 'True'}),
        ...
        u'umatik.moduleselection': {
            ...
            'xtra': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'umatik.news': {
