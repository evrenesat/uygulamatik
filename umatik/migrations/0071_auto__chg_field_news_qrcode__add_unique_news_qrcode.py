...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'News.qrcode'
        db.alter_column(u'umatik_news', 'qrcode_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['qurl.QRcode'], unique=True, null=True))
        # Adding unique constraint on 'News', fields ['qrcode']
        db.create_unique(u'umatik_news', ['qrcode_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'News', fields ['qrcode']
        db.delete_unique(u'umatik_news', ['qrcode_id'])


        # Changing field 'News.qrcode'
        db.alter_column(u'umatik_news', 'qrcode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qurl.QRcode'], null=True))
