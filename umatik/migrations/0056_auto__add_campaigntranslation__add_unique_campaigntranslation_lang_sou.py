...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CampaignTranslation'
        db.create_table(u'umatik_campaigntranslation', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.Campaign'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'umatik', ['CampaignTranslation'])

        # Adding unique constraint on 'CampaignTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_campaigntranslation', ['lang_id', 'source_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CampaignTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_campaigntranslation', ['lang_id', 'source_id'])

        # Deleting model 'CampaignTranslation'
        db.delete_table(u'umatik_campaigntranslation')
