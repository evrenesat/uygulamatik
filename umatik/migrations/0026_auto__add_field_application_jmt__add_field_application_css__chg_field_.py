...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Application.css'
        db.add_column(u'umatik_application', 'css',
        ...
        # Deleting field 'Profile.super'
        db.delete_column(u'umatik_profile', 'super')

        # Adding field 'Profile.root'
        db.add_column(u'umatik_profile', 'root',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Application.css'
        db.delete_column(u'umatik_application', 'css')


        # Changing field 'Theme.css'
        db.alter_column(u'umatik_theme', 'css', self.gf('django.db.models.fields.TextField')(max_length=30, null=True))
        # Adding field 'Profile.super'
        db.add_column(u'umatik_profile', 'super',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Profile.root'
        db.delete_column(u'umatik_profile', 'root')
