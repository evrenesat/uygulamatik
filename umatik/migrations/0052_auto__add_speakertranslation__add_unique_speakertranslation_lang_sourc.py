...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpeakerTranslation'
        db.create_table(u'umatik_speakertranslation', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.Speaker'])),
            ('profile', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'umatik', ['SpeakerTranslation'])

        # Adding unique constraint on 'SpeakerTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_speakertranslation', ['lang_id', 'source_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SpeakerTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_speakertranslation', ['lang_id', 'source_id'])

        # Deleting model 'SpeakerTranslation'
        db.delete_table(u'umatik_speakertranslation')
