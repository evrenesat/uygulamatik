...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Block.lang'
        db.add_column(u'umatik_block', 'lang',
                      self.gf('django.db.models.fields.CharField')(default='tr', max_length=5),
                      keep_default=False)

        # Adding field 'Block.translation'
        db.add_column(u'umatik_block', 'translation',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'umatik_blocktranslation', (
            ...
            ('translation', self.gf('ckeditor.fields.RichTextField')(default='', blank=True)),
        ...
        # Deleting field 'Block.lang'
        db.delete_column(u'umatik_block', 'lang')

        # Deleting field 'Block.translation'
        db.delete_column(u'umatik_block', 'translation')
