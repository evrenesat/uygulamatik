...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApplicationStatus'
        db.create_table(u'umatik_applicationstatus', (
        ...
        db.send_create_signal(u'umatik', ['ApplicationStatus'])

        # Adding field 'Application.status'
        db.add_column(u'umatik_application', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.ApplicationStatus'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Application.active'
        db.add_column(u'umatik_application', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ApplicationStatus'
        db.delete_table(u'umatik_applicationstatus')

        # Deleting field 'Application.status'
        db.delete_column(u'umatik_application', 'status_id')

        # Deleting field 'Application.active'
        db.delete_column(u'umatik_application', 'active')
