...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Icon.theme'
        db.delete_column(u'umatik_icon', 'theme_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Icon.theme'
        raise RuntimeError("Cannot reverse this migration. 'Icon.theme' and its values cannot be restored.")
