...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Icon.keywords'
        db.alter_column(u'umatik_icon', 'keywords', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Icon.keywords'
        raise RuntimeError("Cannot reverse this migration. 'Icon.keywords' and its values cannot be restored.")
