...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SponsorType.app'
        db.add_column(u'umatik_sponsortype', 'app',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['umatik.Application']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SponsorType.app'
        db.delete_column(u'umatik_sponsortype', 'app_id')
