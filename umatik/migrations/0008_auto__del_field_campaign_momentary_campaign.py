...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campaign.momentary_campaign'
        db.delete_column('campaigns', 'momentary_campaign')


    def backwards(self, orm):
        # Adding field 'Campaign.momentary_campaign'
        db.add_column('campaigns', 'momentary_campaign',
