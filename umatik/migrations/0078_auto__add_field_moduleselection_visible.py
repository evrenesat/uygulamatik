...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModuleSelection.visible'
        db.add_column(u'umatik_moduleselection', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModuleSelection.visible'
        db.delete_column(u'umatik_moduleselection', 'visible')
