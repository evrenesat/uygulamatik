...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'umatik_menuitemtranslation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.MenuItem'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'umatik', ['MenuItemTranslation'])

        # Adding model 'MenuCategoryTranslation'
        db.create_table(u'umatik_menucategorytranslation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.MenuCategory'])),
        ))
        db.send_create_signal(u'umatik', ['MenuCategoryTranslation'])

        # Adding model 'ContentTranslation'
        db.create_table(u'umatik_contenttranslation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Content'])),
        ...
        db.send_create_signal(u'umatik', ['ContentTranslation'])

        # Adding unique constraint on 'ContentTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_contenttranslation', ['lang_id', 'source_id'])

        # Adding model 'MenuCategory'
        db.create_table(u'umatik_menucategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Application'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('sort', self.gf('django.db.models.fields.SmallIntegerField')(default=1, null=True, blank=True)),
        ))
        db.send_create_signal(u'umatik', ['MenuCategory'])

        # Adding model 'MenuItem'
        db.create_table(u'umatik_menuitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Application'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.MenuCategory'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('prepare_time', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('sort', self.gf('django.db.models.fields.SmallIntegerField')(default=1, null=True, blank=True)),
        ))
        db.send_create_signal(u'umatik', ['MenuItem'])

        # Adding model 'Content'
        db.create_table(u'umatik_content', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Application'])),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['umatik.Content'])),
            ...
            ('custom_icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'ContentTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_contenttranslation', ['lang_id', 'source_id'])

        # Deleting model 'MenuItemTranslation'
        db.delete_table(u'umatik_menuitemtranslation')

        # Deleting model 'MenuCategoryTranslation'
        db.delete_table(u'umatik_menucategorytranslation')

        # Deleting model 'ContentTranslation'
        db.delete_table(u'umatik_contenttranslation')

        # Deleting model 'MenuCategory'
        db.delete_table(u'umatik_menucategory')

        # Deleting model 'MenuItem'
        db.delete_table(u'umatik_menuitem')
    ...
    models = {
        ...
        u'umatik.contenttranslation': {
            ...
            'menu_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['umatik.Content']"}),
            'summary': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True', 'blank': 'True'}),
