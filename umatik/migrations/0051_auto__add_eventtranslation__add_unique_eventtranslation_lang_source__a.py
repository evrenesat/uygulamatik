...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'umatik_eventtranslation', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.Event'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'umatik', ['EventTranslation'])

        # Adding unique constraint on 'EventTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_eventtranslation', ['lang_id', 'source_id'])

        # Adding model 'ExhibitorTranslation'
        db.create_table(u'umatik_exhibitortranslation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lang', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.AppLang'])),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Application'])),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.Exhibitor'])),
            ('company', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('profile', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'umatik', ['ExhibitorTranslation'])

        # Adding unique constraint on 'ExhibitorTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_exhibitortranslation', ['lang_id', 'source_id'])

        # Adding model 'ExhibitorFilesTranslation'
        db.create_table(u'umatik_exhibitorfilestranslation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lang', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.AppLang'])),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Application'])),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.ExhibitorFiles'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal(u'umatik', ['ExhibitorFilesTranslation'])

        # Adding unique constraint on 'ExhibitorFilesTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_exhibitorfilestranslation', ['lang_id', 'source_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ExhibitorFilesTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_exhibitorfilestranslation', ['lang_id', 'source_id'])

        # Removing unique constraint on 'ExhibitorTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_exhibitortranslation', ['lang_id', 'source_id'])

        # Removing unique constraint on 'EventTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_eventtranslation', ['lang_id', 'source_id'])

        # Deleting model 'EventTranslation'
        db.delete_table(u'umatik_eventtranslation')

        # Deleting model 'ExhibitorTranslation'
        db.delete_table(u'umatik_exhibitortranslation')

        # Deleting model 'ExhibitorFilesTranslation'
        db.delete_table(u'umatik_exhibitorfilestranslation')
