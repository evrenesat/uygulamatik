...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'umatik_placetranslation', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.Place'])),
            ('description', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
        ))
        db.send_create_signal(u'umatik', ['PlaceTranslation'])

        # Adding unique constraint on 'PlaceTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_placetranslation', ['lang_id', 'source_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PlaceTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_placetranslation', ['lang_id', 'source_id'])

        # Deleting model 'PlaceTranslation'
        db.delete_table(u'umatik_placetranslation')
