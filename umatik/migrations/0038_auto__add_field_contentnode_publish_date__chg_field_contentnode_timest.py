...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentNode.publish_date'
        db.add_column(u'umatik_contentnode', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


        # Changing field 'ContentNode.timestamp'
        db.alter_column(u'umatik_contentnode', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'ContentNode.publish_date'
        db.delete_column(u'umatik_contentnode', 'publish_date')


        # Changing field 'ContentNode.timestamp'
        db.alter_column(u'umatik_contentnode', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
