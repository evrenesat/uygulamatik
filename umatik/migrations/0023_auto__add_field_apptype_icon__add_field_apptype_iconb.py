...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppType.icon'
        db.add_column(u'umatik_apptype', 'icon',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppType.iconb'
        db.add_column(u'umatik_apptype', 'iconb',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppType.icon'
        db.delete_column(u'umatik_apptype', 'icon')

        # Deleting field 'AppType.iconb'
        db.delete_column(u'umatik_apptype', 'iconb')
