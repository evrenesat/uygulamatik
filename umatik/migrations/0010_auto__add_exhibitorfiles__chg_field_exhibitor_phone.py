...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExhibitorFiles'
        db.create_table(u'umatik_exhibitorfiles', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Application'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('exhibitor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Exhibitor'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'umatik', ['ExhibitorFiles'])


        # Changing field 'Exhibitor.phone'
        db.alter_column('exhibitor', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):
        # Deleting model 'ExhibitorFiles'
        db.delete_table(u'umatik_exhibitorfiles')


        # Changing field 'Exhibitor.phone'
        db.alter_column('exhibitor', 'phone', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
