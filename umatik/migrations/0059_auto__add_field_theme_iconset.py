...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field theme on 'Icon'
        db.delete_table('umatik_icon_theme')

        # Adding field 'Theme.iconset'
        db.add_column(u'umatik_theme', 'iconset',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['umatik.IconCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding M2M table for field theme on 'Icon'
        db.create_table(u'umatik_icon_theme', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('icon', models.ForeignKey(orm[u'umatik.icon'], null=False)),
            ('theme', models.ForeignKey(orm[u'umatik.theme'], null=False))
        ))
        db.create_unique(u'umatik_icon_theme', ['icon_id', 'theme_id'])

        # Deleting field 'Theme.iconset'
        db.delete_column(u'umatik_theme', 'iconset_id')
