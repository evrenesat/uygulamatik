...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IconCategory'
        db.create_table(u'umatik_iconcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('sort', self.gf('django.db.models.fields.SmallIntegerField')(default=1, null=True, blank=True)),
        ))
        db.send_create_signal(u'umatik', ['IconCategory'])

        # Adding field 'Icon.category'
        db.add_column(u'umatik_icon', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.IconCategory'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'IconCategory'
        db.delete_table(u'umatik_iconcategory')

        # Deleting field 'Icon.category'
        db.delete_column(u'umatik_icon', 'category_id')
