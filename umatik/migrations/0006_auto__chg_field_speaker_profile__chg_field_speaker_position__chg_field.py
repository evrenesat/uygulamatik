...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Speaker.position'
        db.alter_column('speaker', 'position', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Speaker.company'
        db.alter_column('speaker', 'company', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Speaker.profile'
        raise RuntimeError("Cannot reverse this migration. 'Speaker.profile' and its values cannot be restored.")

        # Changing field 'Speaker.position'
        db.alter_column('speaker', 'position', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Speaker.company'
        db.alter_column('speaker', 'company', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
