...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('event', 'description', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'News.detail'
        db.alter_column(u'umatik_news', 'detail', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'PageTranslation.detail'
        db.alter_column(u'umatik_pagetranslation', 'detail', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'MenuItemTranslation.description'
        db.alter_column(u'umatik_menuitemtranslation', 'description', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'CampaignTranslation.description'
        db.alter_column(u'umatik_campaigntranslation', 'description', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'Place.description'
        db.alter_column('places', 'description', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Feedback.msg'
        db.alter_column(u'umatik_feedback', 'msg', self.gf('ckeditor.fields.RichTextField')(max_length=30))

        # Changing field 'Feedback.notes'
        db.alter_column(u'umatik_feedback', 'notes', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'EventTranslation.description'
        db.alter_column(u'umatik_eventtranslation', 'description', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'Speaker.profile'
        db.alter_column('speaker', 'profile', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Application.css'
        db.alter_column(u'umatik_application', 'css', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Sponsor.profile'
        db.alter_column(u'umatik_sponsor', 'profile', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'Page.detail'
        db.alter_column(u'umatik_page', 'detail', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'DelegateTranslation.profile'
        db.alter_column(u'umatik_delegatetranslation', 'profile', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'NewsTranslation.detail'
        db.alter_column(u'umatik_newstranslation', 'detail', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'ExhibitorTranslation.profile'
        db.alter_column(u'umatik_exhibitortranslation', 'profile', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'ContentTranslation.detail'
        db.alter_column(u'umatik_contenttranslation', 'detail', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'PlaceTranslation.description'
        db.alter_column(u'umatik_placetranslation', 'description', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Exhibitor.profile'
        db.alter_column('exhibitor', 'profile', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'Campaign.description'
        db.alter_column('campaigns', 'description', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'Delegate.profile'
        db.alter_column('delegate', 'profile', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'MenuItem.description'
        db.alter_column(u'umatik_menuitem', 'description', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Theme.processed_css'
        db.alter_column(u'umatik_theme', 'processed_css', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Theme.web_processed_css'
        db.alter_column(u'umatik_theme', 'web_processed_css', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Theme.css'
        db.alter_column(u'umatik_theme', 'css', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'SpeakerTranslation.profile'
        db.alter_column(u'umatik_speakertranslation', 'profile', self.gf('ckeditor.fields.RichTextField')(null=True))

        # Changing field 'Content.detail'
        db.alter_column(u'umatik_content', 'detail', self.gf('ckeditor.fields.RichTextField')())

        # Changing field 'ApplicationStatus.description'
        db.alter_column(u'umatik_applicationstatus', 'description', self.gf('ckeditor.fields.RichTextField')(max_length=140))

        # Changing field 'BlockTranslation.translation'
        db.alter_column(u'umatik_blocktranslation', 'translation', self.gf('ckeditor.fields.RichTextField')())

    def backwards(self, orm):

        # Changing field 'Event.description'
        db.alter_column('event', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'News.detail'
        db.alter_column(u'umatik_news', 'detail', self.gf('django.db.models.fields.TextField')())

        # Changing field 'PageTranslation.detail'
        db.alter_column(u'umatik_pagetranslation', 'detail', self.gf('django.db.models.fields.TextField')())

        # Changing field 'MenuItemTranslation.description'
        db.alter_column(u'umatik_menuitemtranslation', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CampaignTranslation.description'
        db.alter_column(u'umatik_campaigntranslation', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Place.description'
        db.alter_column('places', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Feedback.msg'
        db.alter_column(u'umatik_feedback', 'msg', self.gf('django.db.models.fields.TextField')(max_length=30))

        # Changing field 'Feedback.notes'
        db.alter_column(u'umatik_feedback', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'EventTranslation.description'
        db.alter_column(u'umatik_eventtranslation', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Speaker.profile'
        db.alter_column('speaker', 'profile', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Application.css'
        db.alter_column(u'umatik_application', 'css', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Sponsor.profile'
        db.alter_column(u'umatik_sponsor', 'profile', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Page.detail'
        db.alter_column(u'umatik_page', 'detail', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DelegateTranslation.profile'
        db.alter_column(u'umatik_delegatetranslation', 'profile', self.gf('django.db.models.fields.TextField')())

        # Changing field 'NewsTranslation.detail'
        db.alter_column(u'umatik_newstranslation', 'detail', self.gf('django.db.models.fields.TextField')())

        # Changing field 'ExhibitorTranslation.profile'
        db.alter_column(u'umatik_exhibitortranslation', 'profile', self.gf('django.db.models.fields.TextField')())

        # Changing field 'ContentTranslation.detail'
        db.alter_column(u'umatik_contenttranslation', 'detail', self.gf('django.db.models.fields.TextField')())

        # Changing field 'PlaceTranslation.description'
        db.alter_column(u'umatik_placetranslation', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Exhibitor.profile'
        db.alter_column('exhibitor', 'profile', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Campaign.description'
        db.alter_column('campaigns', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Delegate.profile'
        db.alter_column('delegate', 'profile', self.gf('django.db.models.fields.TextField')())

        # Changing field 'MenuItem.description'
        db.alter_column(u'umatik_menuitem', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Theme.processed_css'
        db.alter_column(u'umatik_theme', 'processed_css', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Theme.web_processed_css'
        db.alter_column(u'umatik_theme', 'web_processed_css', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Theme.css'
        db.alter_column(u'umatik_theme', 'css', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'SpeakerTranslation.profile'
        db.alter_column(u'umatik_speakertranslation', 'profile', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Content.detail'
        db.alter_column(u'umatik_content', 'detail', self.gf('django.db.models.fields.TextField')())

        # Changing field 'ApplicationStatus.description'
        db.alter_column(u'umatik_applicationstatus', 'description', self.gf('django.db.models.fields.TextField')(max_length=140))

        # Changing field 'BlockTranslation.translation'
        db.alter_column(u'umatik_blocktranslation', 'translation', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'umatik.icon': {
            ...
            'theme': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['umatik.Theme']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'umatik.theme': {
            ...
            'processed_css': ('ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'web_processed_css': ('ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'umatik.themeimage': {
