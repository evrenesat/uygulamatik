...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DelegateTranslation'
        db.create_table(u'umatik_delegatetranslation', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.Delegate'])),
            ('profile', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'umatik', ['DelegateTranslation'])

        # Adding unique constraint on 'DelegateTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_delegatetranslation', ['lang_id', 'source_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'DelegateTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_delegatetranslation', ['lang_id', 'source_id'])

        # Deleting model 'DelegateTranslation'
        db.delete_table(u'umatik_delegatetranslation')


        # Changing field 'SpeakerTranslation.profile'
        db.alter_column(u'umatik_speakertranslation', 'profile', self.gf('django.db.models.fields.TextField')(default=''))
