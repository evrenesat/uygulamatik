...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'umatik_newstranslation', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.News'])),
        ...
        db.send_create_signal(u'umatik', ['NewsTranslation'])

        # Adding unique constraint on 'NewsTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_newstranslation', ['lang_id', 'source_id'])

        # Adding field 'News.publish_date'
        db.add_column(u'umatik_news', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


        # Changing field 'News.timestamp'
        db.alter_column(u'umatik_news', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Removing unique constraint on 'NewsTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_newstranslation', ['lang_id', 'source_id'])

        # Deleting model 'NewsTranslation'
        db.delete_table(u'umatik_newstranslation')

        # Deleting field 'News.publish_date'
        db.delete_column(u'umatik_news', 'publish_date')


        # Changing field 'News.timestamp'
        db.alter_column(u'umatik_news', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
