...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Block.keyword'
        db.alter_column(u'umatik_block', 'keyword', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Block.keyword'
        db.alter_column(u'umatik_block', 'keyword', self.gf('django.db.models.fields.CharField')(max_length=100))
