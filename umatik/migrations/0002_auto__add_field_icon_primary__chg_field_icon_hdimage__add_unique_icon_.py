...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Icon.primary'
        db.add_column(u'umatik_icon', 'primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Icon.hdimage'
        db.alter_column(u'umatik_icon', 'hdimage', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
        # Adding unique constraint on 'Icon', fields ['primary', 'module']
        db.create_unique(u'umatik_icon', ['primary', 'module_id'])

        # Adding unique constraint on 'ModuleSelection', fields ['app', 'module']
        db.create_unique(u'umatik_moduleselection', ['app_id', 'module_id'])

        # Deleting field 'Module.icon'
        db.delete_column(u'umatik_module', 'icon')


        # Changing field 'Theme.codename'
        db.alter_column(u'umatik_theme', 'codename', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Theme.css'
        db.alter_column(u'umatik_theme', 'css', self.gf('django.db.models.fields.TextField')(max_length=30, null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'ModuleSelection', fields ['app', 'module']
        db.delete_unique(u'umatik_moduleselection', ['app_id', 'module_id'])

        # Removing unique constraint on 'Icon', fields ['primary', 'module']
        db.delete_unique(u'umatik_icon', ['primary', 'module_id'])

        # Deleting field 'Icon.primary'
        db.delete_column(u'umatik_icon', 'primary')


        # User chose to not deal with backwards NULL issues for 'Icon.hdimage'
        raise RuntimeError("Cannot reverse this migration. 'Icon.hdimage' and its values cannot be restored.")
        # Adding field 'Module.icon'
        db.add_column(u'umatik_module', 'icon',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Theme.codename'
        db.alter_column(u'umatik_theme', 'codename', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'Theme.css'
        db.alter_column(u'umatik_theme', 'css', self.gf('django.db.models.fields.TextField')(default='', max_length=30))
