...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.map'
        db.add_column(u'umatik_node', 'map',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['umatik.Map']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.map'
        db.delete_column(u'umatik_node', 'map_id')
