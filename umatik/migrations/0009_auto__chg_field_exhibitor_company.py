...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exhibitor.company'
        db.alter_column('exhibitor', 'company', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

    def backwards(self, orm):

        # Changing field 'Exhibitor.company'
        db.alter_column('exhibitor', 'company', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
