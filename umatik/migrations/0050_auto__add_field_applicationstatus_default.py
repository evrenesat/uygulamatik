...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplicationStatus.default'
        db.add_column(u'umatik_applicationstatus', 'default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplicationStatus.default'
        db.delete_column(u'umatik_applicationstatus', 'default')
