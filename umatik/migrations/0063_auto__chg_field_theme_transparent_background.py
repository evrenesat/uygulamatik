...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Theme.transparent_background'
        db.alter_column(u'umatik_theme', 'transparent_background', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'Theme.transparent_background'
        db.alter_column(u'umatik_theme', 'transparent_background', self.gf('django.db.models.fields.CharField')(max_length=2))
