...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'umatik_sponsor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Application'])),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.SponsorType'])),
            ('company', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ...
        db.send_create_signal(u'umatik', ['Sponsor'])

        # Adding model 'SponsorType'
        db.create_table(u'umatik_sponsortype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'umatik', ['SponsorType'])


    def backwards(self, orm):
        # Deleting model 'Sponsor'
        db.delete_table(u'umatik_sponsor')

        # Deleting model 'SponsorType'
        db.delete_table(u'umatik_sponsortype')
    ...
    models = {
        ...
        u'umatik.sponsortype': {
            'Meta': {'ordering': "['timestamp']", 'object_name': 'SponsorType'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
