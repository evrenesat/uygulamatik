...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.show_qrcode_button'
        db.add_column(u'umatik_application', 'show_qrcode_button',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.show_qrcode_button'
        db.delete_column(u'umatik_application', 'show_qrcode_button')
