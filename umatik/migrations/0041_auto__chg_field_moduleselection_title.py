...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ModuleSelection.title'
        db.alter_column(u'umatik_moduleselection', 'title', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ModuleSelection.title'
        raise RuntimeError("Cannot reverse this migration. 'ModuleSelection.title' and its values cannot be restored.")
