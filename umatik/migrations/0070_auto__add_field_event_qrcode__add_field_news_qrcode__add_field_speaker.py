...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.qrcode'
        db.add_column('event', 'qrcode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qurl.QRcode'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'News.qrcode'
        db.add_column(u'umatik_news', 'qrcode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qurl.QRcode'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Speaker.qrcode'
        db.add_column('speaker', 'qrcode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qurl.QRcode'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sponsor.qrcode'
        db.add_column(u'umatik_sponsor', 'qrcode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qurl.QRcode'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.qrcode'
        db.add_column(u'umatik_page', 'qrcode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qurl.QRcode'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exhibitor.qrcode'
        db.add_column('exhibitor', 'qrcode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qurl.QRcode'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Map.qrcode'
        db.add_column(u'umatik_map', 'qrcode',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qurl.QRcode'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.qrcode'
        db.delete_column('event', 'qrcode_id')

        # Deleting field 'News.qrcode'
        db.delete_column(u'umatik_news', 'qrcode_id')

        # Deleting field 'Speaker.qrcode'
        db.delete_column('speaker', 'qrcode_id')

        # Deleting field 'Sponsor.qrcode'
        db.delete_column(u'umatik_sponsor', 'qrcode_id')

        # Deleting field 'Page.qrcode'
        db.delete_column(u'umatik_page', 'qrcode_id')

        # Deleting field 'Exhibitor.qrcode'
        db.delete_column('exhibitor', 'qrcode_id')

        # Deleting field 'Map.qrcode'
        db.delete_column(u'umatik_map', 'qrcode_id')
    ...
    models = {
        ...
        u'umatik.block': {
            'Meta': {'ordering': "['keyword']", 'object_name': 'Block'},
            ...
            'translation': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'})
        },
        u'umatik.campaign': {
        ...
        u'umatik.event': {
            ...
            'qrcode': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['qurl.QRcode']", 'null': 'True', 'blank': 'True'}),
