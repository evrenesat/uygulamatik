...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Block.status'
        db.delete_column(u'umatik_block', 'status')

        # Deleting field 'Block.type'
        db.delete_column(u'umatik_block', 'type')

        # Adding field 'Block.translated'
        db.add_column(u'umatik_block', 'translated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Block.translation'
        db.alter_column(u'umatik_block', 'translation', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Adding field 'Block.status'
        db.add_column(u'umatik_block', 'status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Block.type'
        db.add_column(u'umatik_block', 'type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Block.translated'
        db.delete_column(u'umatik_block', 'translated')


        # Changing field 'Block.translation'
        db.alter_column(u'umatik_block', 'translation', self.gf('ckeditor.fields.RichTextField')())
    ...
    models = {
        ...
        u'umatik.application': {
            ...
            'subdomain': ('django.db.models.fields.SlugField', [], {'max_length': '25'}),
