...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.subdomain'
        db.add_column(u'umatik_application', 'subdomain',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.subdomain'
        db.delete_column(u'umatik_application', 'subdomain')
