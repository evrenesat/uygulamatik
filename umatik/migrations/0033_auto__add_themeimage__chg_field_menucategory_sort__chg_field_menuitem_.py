...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ThemeImage'
        db.create_table(u'umatik_themeimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('theme', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Theme'])),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'umatik', ['ThemeImage'])


        # Changing field 'MenuCategory.sort'
        db.alter_column(u'umatik_menucategory', 'sort', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'MenuItem.sort'
        db.alter_column(u'umatik_menuitem', 'sort', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
        # Adding field 'Theme.processed_css'
        db.add_column(u'umatik_theme', 'processed_css',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ThemeImage'
        db.delete_table(u'umatik_themeimage')


        # Changing field 'MenuCategory.sort'
        db.alter_column(u'umatik_menucategory', 'sort', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'MenuItem.sort'
        db.alter_column(u'umatik_menuitem', 'sort', self.gf('django.db.models.fields.SmallIntegerField')())
        # Deleting field 'Theme.processed_css'
        db.delete_column(u'umatik_theme', 'processed_css')
