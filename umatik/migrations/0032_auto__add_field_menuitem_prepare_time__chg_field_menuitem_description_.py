...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MenuItem.prepare_time'
        db.add_column(u'umatik_menuitem', 'prepare_time',
        ...
        db.alter_column(u'umatik_menuitem', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'MenuItem.prepare_time'
        db.delete_column(u'umatik_menuitem', 'prepare_time')


        # Changing field 'MenuItem.description'
        db.alter_column(u'umatik_menuitem', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # User chose to not deal with backwards NULL issues for 'MenuItem.price'
        raise RuntimeError("Cannot reverse this migration. 'MenuItem.price' and its values cannot be restored.")
