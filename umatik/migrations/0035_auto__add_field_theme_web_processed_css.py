...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Theme.web_processed_css'
        db.add_column(u'umatik_theme', 'web_processed_css',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Theme.web_processed_css'
        db.delete_column(u'umatik_theme', 'web_processed_css')
