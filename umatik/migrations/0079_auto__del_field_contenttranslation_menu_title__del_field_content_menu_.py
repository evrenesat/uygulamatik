...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ContentTranslation.menu_title'
        db.delete_column(u'umatik_contenttranslation', 'menu_title')

        # Deleting field 'Content.menu_title'
        db.delete_column(u'umatik_content', 'menu_title')


    def backwards(self, orm):
        # Adding field 'ContentTranslation.menu_title'
        db.add_column(u'umatik_contenttranslation', 'menu_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Content.menu_title'
        db.add_column(u'umatik_content', 'menu_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
