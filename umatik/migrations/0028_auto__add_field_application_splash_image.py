...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.splash_image'
        db.add_column(u'umatik_application', 'splash_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.splash_image'
        db.delete_column(u'umatik_application', 'splash_image')
