...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Application.jmt'
        db.delete_column(u'umatik_application', 'jmt')

        # Adding field 'Application.app_bg'
        db.add_column(u'umatik_application', 'app_bg',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Theme.jmt'
        db.delete_column(u'umatik_theme', 'jmt')

        # Adding field 'Theme.transparent_background'
        db.add_column(u'umatik_theme', 'transparent_background',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Application.jmt'
        db.add_column(u'umatik_application', 'jmt',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=2),
                      keep_default=False)

        # Deleting field 'Application.app_bg'
        db.delete_column(u'umatik_application', 'app_bg')

        # Adding field 'Theme.jmt'
        db.add_column(u'umatik_theme', 'jmt',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=2),
                      keep_default=False)

        # Deleting field 'Theme.transparent_background'
        db.delete_column(u'umatik_theme', 'transparent_background')
    ...
    models = {
        ...
        u'umatik.theme': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'transparent_background': ('django.db.models.fields.CharField', [], {'default': "'a'", 'max_length': '2'}),
