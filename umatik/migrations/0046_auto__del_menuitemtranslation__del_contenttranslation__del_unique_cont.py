...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ContentTranslation', fields ['lang', 'node']
        db.delete_unique(u'umatik_contenttranslation', ['lang_id', 'node_id'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'umatik_menuitemtranslation', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.MenuItem'])),
        ...
        db.create_table(u'umatik_contenttranslation', (
            ...
            ('node', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.Content'])),
        ...
        # Adding unique constraint on 'ContentTranslation', fields ['lang', 'node']
        db.create_unique(u'umatik_contenttranslation', ['lang_id', 'node_id'])

        # Adding model 'MenuCategoryTranslation'
        db.create_table(u'umatik_menucategorytranslation', (
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Application'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.MenuCategory'])),
        ))
        ...
        db.create_table(u'umatik_content', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(related_name='children', null=True, to=orm['umatik.Content'], blank=True)),
