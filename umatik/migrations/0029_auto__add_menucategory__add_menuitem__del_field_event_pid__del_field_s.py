...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'umatik_menuitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Application'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.MenuCategory'], null=True, blank=True)),
        ...
        # Deleting field 'Event.pid'
        db.delete_column('event', 'pid')

        # Deleting field 'Speaker.pid'
        db.delete_column('speaker', 'pid')

        # Deleting field 'Delegate.pid'
        db.delete_column('delegate', 'pid')

        # Deleting field 'Exhibitor.pid'
        db.delete_column('exhibitor', 'pid')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Event.pid'
        raise RuntimeError("Cannot reverse this migration. 'Event.pid' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Speaker.pid'
        raise RuntimeError("Cannot reverse this migration. 'Speaker.pid' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Delegate.pid'
        raise RuntimeError("Cannot reverse this migration. 'Delegate.pid' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Exhibitor.pid'
        raise RuntimeError("Cannot reverse this migration. 'Exhibitor.pid' and its values cannot be restored.")
    ...
    models = {
        ...
        u'umatik.menuitem': {
            ...
            'app': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['umatik.Application']"}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['umatik.MenuCategory']", 'null': 'True', 'blank': 'True'}),
