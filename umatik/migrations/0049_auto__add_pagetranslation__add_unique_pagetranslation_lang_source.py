...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'umatik_pagetranslation', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.Page'])),
        ...
        db.send_create_signal(u'umatik', ['PageTranslation'])

        # Adding unique constraint on 'PageTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_pagetranslation', ['lang_id', 'source_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PageTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_pagetranslation', ['lang_id', 'source_id'])

        # Deleting model 'PageTranslation'
        db.delete_table(u'umatik_pagetranslation')
