...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MenuItem.discount_rate'
        db.delete_column(u'umatik_menuitem', 'discount_rate')


        # Changing field 'MenuItem.category'
        db.alter_column(u'umatik_menuitem', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['umatik.MenuCategory']))

    def backwards(self, orm):
        # Adding field 'MenuItem.discount_rate'
        db.add_column(u'umatik_menuitem', 'discount_rate',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=2, null=True, blank=True),
                      keep_default=False)


        # Changing field 'MenuItem.category'
        db.alter_column(u'umatik_menuitem', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.MenuCategory'], null=True))
