...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'umatik_productcategorytranslation', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.ProductCategory'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal(u'umatik', ['ProductCategoryTranslation'])

        # Adding unique constraint on 'ProductCategoryTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_productcategorytranslation', ['lang_id', 'source_id'])

        # Adding model 'StoreProductCategoryTranslation'
        db.create_table(u'umatik_storeproductcategorytranslation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lang', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.AppLang'])),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umatik.Application'])),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['umatik.StoreProductCategory'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal(u'umatik', ['StoreProductCategoryTranslation'])

        # Adding unique constraint on 'StoreProductCategoryTranslation', fields ['lang', 'source']
        db.create_unique(u'umatik_storeproductcategorytranslation', ['lang_id', 'source_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StoreProductCategoryTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_storeproductcategorytranslation', ['lang_id', 'source_id'])

        # Removing unique constraint on 'ProductCategoryTranslation', fields ['lang', 'source']
        db.delete_unique(u'umatik_productcategorytranslation', ['lang_id', 'source_id'])

        # Deleting model 'ProductCategoryTranslation'
        db.delete_table(u'umatik_productcategorytranslation')

        # Deleting model 'StoreProductCategoryTranslation'
        db.delete_table(u'umatik_storeproductcategorytranslation')
