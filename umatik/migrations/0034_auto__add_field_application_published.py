...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.published'
        db.add_column(u'umatik_application', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.published'
        db.delete_column(u'umatik_application', 'published')
