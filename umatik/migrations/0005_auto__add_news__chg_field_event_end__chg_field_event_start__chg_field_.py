...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'umatik', ['News'])


        # Changing field 'Event.end'
        db.alter_column('event', 'end', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Event.start'
        db.alter_column('event', 'start', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Application.company'
        db.alter_column(u'umatik_application', 'company', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Application.name_long'
        db.alter_column(u'umatik_application', 'name_long', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.end'
        db.alter_column('event', 'end', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2013, 1, 14, 0, 0)))

        # Changing field 'Event.start'
        db.alter_column('event', 'start', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2013, 1, 14, 0, 0)))

        # Changing field 'Application.company'
        db.alter_column(u'umatik_application', 'company', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Application.name_long'
        db.alter_column(u'umatik_application', 'name_long', self.gf('django.db.models.fields.CharField')(default='', max_length=70))
